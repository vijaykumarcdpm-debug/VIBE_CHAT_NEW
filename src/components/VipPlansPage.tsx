...
export default function VipPlansPage({
  ...
  const mainContent = submissionSuccess ? (
  ...
  return (
    <div className="w-full flex-1 overflow-y-auto max-w-4xl mx-auto px-4 py-8">
      ...
      {selectedPlan && (
        <div className={`fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6 backdrop-blur-md animate-fade-in ${theme === 'light' ? 'bg-slate-900/60' : 'bg-black/80'}`}>
          <div className={`w-full max-w-4xl flex flex-col rounded-3xl shadow-2xl relative max-h-[95%] md:max-h-[90%] overflow-hidden ${theme === "light" ? "bg-white border border-slate-200" : "bg-slate-950 border border-slate-800"}`}>
            <div className="flex-1 overflow-y-auto p-6 sm:p-8">
              {/* Modal Header */}
              <div className="flex justify-between items-start mb-6 gap-4 mt-2 sm:mt-0">
                ...
                <button
                  ...
                  className={`shrink-0 p-2 rounded-full transition cursor-pointer ${theme === "light" ? "bg-slate-100 hover:bg-slate-200 text-slate-600" : "bg-slate-800 hover:bg-slate-700 text-slate-300"}`}
            ...
            <div className={`px-6 sm:px-8 py-4 sm:py-6 flex-shrink-0 border-t ${theme === "light" ? "border-slate-100 bg-slate-50/50" : "border-slate-800/50 bg-slate-900/50"}`}>
              <button
              ...
              <p className={`text-[10px] sm:text-xs font-bold text-center mt-3 sm:mt-4 flex items-center justify-center gap-1.5 ${theme === "light" ? "text-slate-400" : "text-slate-500"}`}>
